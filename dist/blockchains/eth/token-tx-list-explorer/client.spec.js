...
describe.skip('Etherscan Token Tx List Client', () => {
    ...
    beforeAll(() => {
        const API_KEY = '';
        client = new TxListExplorerClient(new EtherscanTokenTxListExplorerRequestAdapter('https://api.etherscan.io', API_KEY), new EtherscanTokenTxListExplorerResponseParser(), parsePagination);
    });
    describe('.getTxs', () => {
