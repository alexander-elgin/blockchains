...
describe.skip('TronScan Token Balance Client', () => {
    let client;
    beforeAll(() => {
        client = new BalanceExplorerClient(new TronScanBalanceExplorerRequestAdapter('https://apilist.tronscan.org/api'), new TronScanTokenBalanceExplorerResponseParser());
    });
    describe('.getData', () => {
