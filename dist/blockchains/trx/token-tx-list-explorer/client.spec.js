...
describe.skip('TronGrid Tx List Token Client', () => {
    let client;
    beforeAll(() => {
        client = new TxListExplorerClient(new TronGridTokenTxListExplorerRequestAdapter('https://api.trongrid.io'), new TronGridTokenTxListExplorerResponseParser(), parsePagination);
    });
    describe('.getTxs', () => {
