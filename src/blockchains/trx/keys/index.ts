...
function getDerivedKey(mnemonic: string) {
...
export function getPrivateKey(mnemonicPhrase: string): string {
...
export function getAddress(mnemonicPhrase: string): string {
